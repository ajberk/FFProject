class CreateWiderecievers < ActiveRecord::Migration
  def change
    create_table :widerecievers do |t|
    ...
    add_index :widerecievers, :Team
    add_index :widerecievers, :Opponent
    add_index :widerecievers, :Points
  end
end
